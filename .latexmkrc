...
# Arch Depends: "sudo pacman -S texlive tex-gyre-fonts ttf-lato biber"
...
set_tex_cmds("--shell-escape --synctex=1 -interaction=nonstopmode --file-line-error --halt-on-error %O %S");
